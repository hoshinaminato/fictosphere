 ...
 */
// Fix: Use React.Component explicitly to ensure state, setState, and props are correctly resolved by TypeScript's inheritance mechanism.
export class GlobalError extends React.Component<GlobalErrorProps, GlobalErrorState> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // Fix: Inheriting from React.Component correctly allows setState to be recognized.
  ...
  render() {
    // Fix: Inheriting from React.Component correctly allows this.state to be recognized.
          ...
          <div className="max-w-2xl w-full bg-gray-900 border border-red-900/50 rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-6">
               <div className="bg-black/50 p-4 rounded border border-gray-800 font-mono text-xs text-red-400 overflow-auto max-h-32">
                  ...
                  {/* Fix: state and errorInfo are now correctly accessible via inheritance. */}
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button 
                     ...
                     // Fix: isRecovering is now correctly accessible from state.
    ...
    // Fix: Correctly access children from props via Component inheritance.
